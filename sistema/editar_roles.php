<style>
  /* Agrega una transición a los switches */
.form-check-input[type="checkbox"] {
    transition: transform 0.3s;
}

/* Cambia la escala del switch cuando está marcado */
...
echo "  </div>
        <button type='submit' class='btn btn-primary' name='guardar' id='botonGuardar'>Guardar</button>
    </form>
</div> </div>";
