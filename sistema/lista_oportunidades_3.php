                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                              ...
                              if (strlen($company) > 20) {
                                  $company = substr($company, 0, 20) . '...';
                              }

                              $oportunidad = $row['Oportunidad'];

                              if (strlen($oportunidad) > 20) {
                                  $oportunidad = substr($oportunidad, 0, 20) . '...';
                              }
                              ...
                              '<a href="editar_sales1.php?id='.$row['id'].'" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>' .
