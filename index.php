...
if (!empty($_SESSION['active'])) {
  ...
  Ingrese su usuario y su clave
      ...
      $query = mysqli_query($conexion, "SELECT u.idusuario, u.nombre, u.correo,u.usuario,r.idrol,r.rol,rx.idPermisoArreglo,rx.crud FROM usuario u INNER JOIN rol r ON u.rol = r.idrol INNER JOIN rolxpermisos rx on rx.idRol = r.idrol WHERE u.usuario = '$user' AND u.clave = '$clave'");
      ...
      if ($resultado > 0) {
        ...
        $_SESSION['Permisos'] = $dato['idPermisoArreglo'];
        $_SESSION['generales'] = $dato['crud'];
        header('location: sistema/');
      } else {
        $alert = '<div class="alert alert-danger" role="alert">
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="sistema/img/JHS.jpg" class="img-thumbnail">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
